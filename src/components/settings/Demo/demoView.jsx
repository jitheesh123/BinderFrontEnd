...
class ViewDemo extends Component {
    ...
    refreshinfoDetails = async () => {
        ...
        if (floorData && floorData.status===200) {
            this.setState({
                basicDetails: {
                    name: floorData.data.name,
                    email:floorData.data.email,
                    id:floorData.data.id,
                    phone:floorData.data.phone,
                }
            });
        }
        return true;
...
export default withRouter(ViewDemo);
