...
import ViewOnlyDefaultRiskATSDetails from "../viewOnlyForms/ViewOnlyDefaultRiskATSDetails";
...
class DefaultRiskFormModal extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            formParams: {
                ...
                device_comments: null,
                comments: null,
                performed_by: null,
                ats_used_to_start_test: null,
                previous_event_ats: null,
    ...
    componentDidMount = async () => {
        ...
        await this.setState({
            formParams: {
                ...
                total_devices: surveyDetails.total_devices,
                ...
                device_comments: surveyDetails.device_comments,
                performed_by: surveyDetails.performed_by,
                ats_used_to_start_test: surveyDetails.ats_used_to_start_test,
                previous_event_ats: surveyDetails.previous_event_ats,
    ...
    validate = () => {
        ...
        if (formParams.number_fail) {
            if (formParams.risk_assessment === "no" || !formParams.risk_assessment_comments || !formParams.risk_assessment_comments.trim().length) {
                errorParams.risk_assessment = "Risk Assessment and Risk Assessment Comments are required";
                showErrorBorder = true;
            }
        }
        if (formParams.risk_assessment === "yes" && (!formParams.risk_assessment_comments || !formParams.risk_assessment_comments.trim().length)) {
    ...
    saveActivityEvent = () => {
        ...
        if (this.validate()) {
            ...
            let form = {
                ...
                device_comments: formParams.device_comments,
                ats_used_to_start_test: formParams.ats_used_to_start_test,
                surveyable_type: "DefaultRiskAtsForm"
            };
            if (parseInt(formParams.total_devices) === parseInt(formParams.number_pass || 0) + parseInt(formParams.number_fail || 0)) {
                ...
                if (formParams.device_comments && formParams.device_comments.trim().length && formParams.total_device_updated === "yes") {
                    saveActivityEvent({ survey, form, id: formParams.id });
                } else {
                                        ...
                                        <div className="box-form-sec">
                                            <div className="col-md-6 form-itm pr-0">
                                                ...
                                                <div className="itm">
                                                    <div className="form-group">
                                                        ...
                                                        {checkPermission("event", "total_devices", "allow") ? (
                                                            <input
                                                                type="number"
                                                                className="form-control"
                                                                placeholder=" "
                                                                ...
                                                                onChange={e =>
                                                                    this.setState({
                                                                        formParams: {
                                                                            ...formParams,
                                                                            total_devices: e.target.value.length ? parseInt(e.target.value) : ""
                                                                        }
                                                                    })
                                                                }
                                                            />
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={e =>
                                                                this.setState({
                                                                    formParams: {
                                                                        ...formParams,
                                                                        number_pass: e.target.value.length ? parseInt(e.target.value) : ""
                                                                    }
                                                                })
                                                            }
                                                        />
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={e =>
                                                                this.setState({
                                                                    formParams: {
                                                                        ...formParams,
                                                                        number_fail: e.target.value.length ? parseInt(e.target.value) : ""
                                                                    }
                                                                })
                                                            }
                                                        />
                                                ...
                                                <div className="box-section mb-2 mt-1 col-md-12 p-0 hide-on-view-only">
                                                    <div className="itm ">
                                                        <div className="form-group">
                                                            <label>ATS Used to Start Test</label>
                                                            <input
                                                                type="number"
                                                                className="form-control"
                                                                placeholder=" "
                                                                value={formParams.ats_used_to_start_test}
                                                                onChange={e => {
                                                                    this.setState({
                                                                        formParams: {
                                                                            ...formParams,
                                                                            ats_used_to_start_test: e.target.value.length
                                                    ...
                                                    {formParams.previous_event_ats &&
                                                    formParams.ats_used_to_start_test &&
                                                    formParams.previous_event_ats === formParams.ats_used_to_start_test ? (
                                                        <p className="text-red text-error">ATS number is same as PREVIOUS Event</p>
                                                    ) : null}
                                                </div>
                                            </div>
                                            <div className="col-md-3 form-itm frm-2">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={e =>
                                                                this.setState({
                                                                    formParams: {
                                                                        ...formParams,
                                                                        device_comments: e.target.value
                                                                    }
                                                                })
                                                            }
                                                        />
                                                ...
                                                <div className="itm itm-check check-dc mb-2">
                                                    {checkPermission("forms", "device_count", "edit") ? (
                                                        <div className="custom-control custom-checkbox">
                                                            <input
                                                                type="checkbox"
                                                                onClick={e =>
                                                                    this.setState({
                                                                        formParams: {
                                                                            ...
                                                                            total_device_updated:
                                                                                formParams.total_device_updated === "yes" ? "no" : "yes"
                                                                        }
                                                                    })
                                                                }
                                                        ...
                                                        <div className="custom-control custom-checkbox cursor-not-allowed">
                                                            <input
                                                                type="checkbox"
                                                                checked={formParams.total_device_updated === "yes" ? true : false}
                                                                className="custom-control-input cursor-not-allowed"
                                                                id="customCheckdc"
                                                                name="example1"
                                                                disabled={true}
                                                            />
                                                            <label className="custom-control-label cursor-not-allowed" for="customCheckdc">
                                                                DEVICE COUNT UPDATED
                                                            </label>
                                                        </div>
                                                    )}
