...
class FireDrillsBasicFormModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            surveyDetails: {},
    ...
    componentDidMount = async () => {
        ...
        await this.setState({
            formParams: {
                ...
                transmission_of_signal: surveyDetails.transmission_of_signal || "",
    ...
    checkPreviousDay = async day => {
        ...
        if (!previous_days.includes(day)) {
            tempPreviousDays.push(day);
        }
        var nonMatchingItems = weekArray.filter(item => !tempPreviousDays.includes(item));
                                    ...
                                    <div className="aep-tab-contents">
                                        ...
                                        <div className="box-form-sec">
                                            <div className="col-md-6 form-itm pr-0">
                                                ...
                                                <div className="itm ">
                                                    <div className="form-group">
                                                        <label className={showErrorBorder && errorParams.number_pass ? "text-red" : ""}>Result</label>
                                                ...
                                                {formSettings && formSettings.score.visible ? (
                                                    <div className="itm ">
                                                        <div className="form-group">
                                                ...
                                                {formSettings && formSettings.location.visible ? (
                                                    <div className="itm ">
                                                        <div className="form-group">
                                            ...
                                            <div className="col-md-6 form-itm frm-1 pl-2">
                                                ...
                                                {formSettings && formSettings.transmission_of_signal.visible ? (
                                                    <div className="itm itm-check transmission-of-signal mt-2">
...
export default FireDrillsBasicFormModal;
